...
<head runat="server">
    ...
    <style>
        ...
        .tooltip{position:absolute;z-index:999;left:-9999px;background-color:#fafad2;padding:5px;border:1px solid #fff;}
...
<body style="margin-left: 25px; margin-top: 10px; ">
    ...
    <tr>
        ...
        <td align="right" valign="top">
			<a href="javascript:void(0);" onclick="v4_openHelp('<%=IDPage%>');" class="btn" title="<%=Title_Help%>"><img src="/styles/Help.gif" border="0" ></a>
		</td>
	</tr>
    <tr id="tr1" style="margin-bottom: 10">
        <td colspan=2 >
            <table  style="width:100%;" cellpadding=0 cellspacing=0 border=0>
                <tr>
                    ...
                    <td><cs:CheckBox runat="server" ID="chOpenMonth" HtmlID="chOpenMonth" TabIndex="0"></cs:CheckBox></td>
        ...
        <td rowspan="6" style="PADDING-LEFT:15px">
                    <a href="javascript:void(0);" onclick="openRpt(0,'Затраты по телефонам');" class="btn"><img border=0 src="/styles/chart.gif"> <%=TM_Rpt1%></a><br>
	                <a href="javascript:void(0);" onclick="openRpt(1,'Длительность по телефонам');" class="btn"><img border=0 src="/styles/chart.gif"> <%=TM_Rpt2%></a> <br>
	                <a href="javascript:void(0);" onclick="openRpt(2,'Затраты по сотрудникам');" class="btn"><img border=0 src="/styles/chart.gif"> <%=TM_Rpt3%></a> <br>
	                <a href="javascript:void(0);" onclick="openRpt(3, 'Длительность по сотрудникам');" class="btn"><img border=0 src="/styles/chart.gif"> <%=TM_Rpt4%></a> <br><br>
...
<script type="text/javascript">
    ...
    function openDetailItem(pOpenMonth, pYear, pMonth, pDogovor, pDogovorT, pUser, pPhone, bln, pNDSAllSumm, pNDSStavka, pNDSIn, pScale, pColor, pTitle) {
        ...
        v4_windowOpen(url, '_blank', 'width=1180,height=700,menubar=no,location=no,resizable=yes,scrollbars=yes,status=yes')
    }
